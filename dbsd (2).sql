...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2019 at 09:21 PM
...
INSERT INTO `edit_grade` (`ID`, `G_code`, `A`, `B+`, `B`, `C+`, `C`, `D+`, `D`) VALUES
(1, 1, 80, 75, 70, 65, 60, 55, 50),
(2, 2, 75, 70, 65, 60, 55, 50, 45);
...
(13, '1/2561', '60122660100', '9011103', '69', 20, 20, 20, 9, 'B+'),
...
(26, '1/2561', '60122660111', '9011103', '31', 0, 0, 0, 0, 'F');
...
(4, '60122660111', 'Mr.', 'Naruto', 'Uzumaki', '0620323038', 'Japan', '1990-12-25', '1529900975889', 'SE', 'IE', ''),
...
INSERT INTO `table 13` (`COL 1`, `COL 2`, `COL 3`, `COL 4`) VALUES
('using System;', NULL, NULL, NULL),
('using System.Collections;', NULL, NULL, NULL),
('using System.Collections.Generic;', NULL, NULL, NULL),
('using System.Text;', NULL, NULL, NULL),
('namespace Dbgg', NULL, NULL, NULL),
('{', NULL, NULL, NULL),
('    #region Criteria_tb', NULL, NULL, NULL),
('    public class Criteria_tb', NULL, NULL, NULL),
('    {', NULL, NULL, NULL),
('        #region Member Variables', NULL, NULL, NULL),
('        protected int _ctr_id;', NULL, NULL, NULL),
('        protected int _ctr_number;', NULL, NULL, NULL),
('        protected string _ctr_score;', NULL, NULL, NULL),
('        protected string _ctr_font;', NULL, NULL, NULL),
('        protected string _ctr_name;', NULL, NULL, NULL),
('        #endregion', NULL, NULL, NULL),
('        #region Constructors', NULL, NULL, NULL),
('        public Criteria_tb() { }', NULL, NULL, NULL),
('        public Criteria_tb(int ctr_number', ' string ctr_score', ' string ctr_font', ' string ctr_name)'),
('        {', NULL, NULL, NULL),
('            this._ctr_number=ctr_number;', NULL, NULL, NULL),
('            this._ctr_score=ctr_score;', NULL, NULL, NULL),
('            this._ctr_font=ctr_font;', NULL, NULL, NULL),
('            this._ctr_name=ctr_name;', NULL, NULL, NULL),
('        }', NULL, NULL, NULL),
('        #endregion', NULL, NULL, NULL),
('        #region Public Properties', NULL, NULL, NULL),
('        public virtual int Ctr_id', NULL, NULL, NULL),
('        {', NULL, NULL, NULL),
('            get {return _ctr_id;}', NULL, NULL, NULL),
('            set {_ctr_id=value;}', NULL, NULL, NULL),
('        }', NULL, NULL, NULL),
('        public virtual int Ctr_number', NULL, NULL, NULL),
('        {', NULL, NULL, NULL),
('            get {return _ctr_number;}', NULL, NULL, NULL),
('            set {_ctr_number=value;}', NULL, NULL, NULL),
('        }', NULL, NULL, NULL),
('        public virtual string Ctr_score', NULL, NULL, NULL),
('        {', NULL, NULL, NULL),
('            get {return _ctr_score;}', NULL, NULL, NULL),
('            set {_ctr_score=value;}', NULL, NULL, NULL),
('        }', NULL, NULL, NULL),
('        public virtual string Ctr_font', NULL, NULL, NULL),
('        {', NULL, NULL, NULL),
('            get {return _ctr_font;}', NULL, NULL, NULL),
('            set {_ctr_font=value;}', NULL, NULL, NULL),
('        }', NULL, NULL, NULL),
('        public virtual string Ctr_name', NULL, NULL, NULL),
('        {', NULL, NULL, NULL),
('            get {return _ctr_name;}', NULL, NULL, NULL),
('            set {_ctr_name=value;}', NULL, NULL, NULL),
('        }', NULL, NULL, NULL),
('        #endregion', NULL, NULL, NULL),
('    }', NULL, NULL, NULL),
('    #endregion', NULL, NULL, NULL),
