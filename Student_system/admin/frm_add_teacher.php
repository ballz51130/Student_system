...
<body >
            ...
            <hr>
            <form id="myform" name='myform' method="POST" action="./addTeacher.php">
                <!-- รหัสนักศึกษา -->
                <div class="form-group row">
        
                    <label for="colFormLabelSm"
                        class="col-sm-4 text-right col-form-label col-form-label-sm font-weight-bold">รหัสอาจารย์ : </label>
                    <div class="col-sm-5">
