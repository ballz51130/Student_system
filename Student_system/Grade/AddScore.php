...
<body>
    <div class="card p-5 mt-5 mr-5 ml-5 text-center">
        ...
        <center>
            ...
            คะแนนครั้งที่ : 1 &emsp;&emsp;&emsp; <input type="number" class="form-control" id="txtGrade" placeholder="คะแนน" name="txtGrade1" style="width:100px;" min="0" max="20" title="โปรดกรอกคะแนนตั้งแต่ 0 - 20 !" value="<?php echo $result5['P1'] ?>" required>
            คะแนนครั้งที่ : 2 &emsp;&emsp;&emsp; <input type="number" class="form-control" id="txtGrade" placeholder="คะแนน" name="txtGrade2" style="width:100px;" min="0" max="20" title="โปรดกรอกคะแนนตั้งแต่ 0 - 20 !" value="<?php echo $result5['P2'] ?>" required>


            คะแนนสอบกลางภาค : &nbsp; <input type="number" class="form-control" id="txtGrade" placeholder="คะแนน" name="txtGradeMid" style="width:100px;" min="0" max="30" title="โปรดกรอกคะแนนตั้งแต่ 0 - 30 !" value="<?php echo $result5['Mid'] ?>" required>

            คะแนนสอบปลายภาค : &nbsp;<input type="number" class="form-control" id="txtGrade" placeholder="คะแนน" name="txtGradeFinal" style="width:100px;" min="0" max="30" title="โปรดกรอกคะแนนตั้งแต่ 0 - 30 !" value="<?php echo $result5['Final'] ?>" required>
