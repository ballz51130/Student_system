...
<html lang="en">
  ...
  <form  name="login" method = "POST" action = "./login/check_login.php" class="form-signin col-3 mt-5">
  <img class="mb-4" src="../testt/128x128.png" alt="" width="200" height="200">
  <h1 class="h3 mb-3 font-weight-normal">LOGIN-SE-LPRU</h1>
  ...
  <input type="password" name="password" id="password" class="form-control mt-3" placeholder="Password" required><br>
